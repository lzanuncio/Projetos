...
if (isset($_REQUEST['altera'])){
	...
	if(!empty($_POST['opcao']) && count($_POST['opcao']) ){
		$itens = implode(',', $_POST['opcao']);
	}
...
element.on( 'click', function( ev ) {
	...
	function someFunction(){
		alert('09');
							...
							<div class="row">
								<div class="col-md-5">
									<input id="nome_usuario" type="checkbox" name="opcao[]" value="a1" <?php foreach($array_opcoes as $verificacao){if($verificacao == "a1"){echo "checked";}}?>>
									<label for="nome_usuario">$nome_usuario$</label>
								</div>
								<div class="col-md-4">
									<input id="login-check" type="checkbox" name="opcao[]" value="b1" <?php foreach($array_opcoes as $verificacao){if($verificacao == "b1"){echo "checked";}}?>>
									<label for="login-check">$login$</label>
								</div>
								<div class="col-md-3">
									<input id="senha" type="checkbox" name="opcao[]" value="c1" <?php foreach($array_opcoes as $verificacao){if($verificacao == "c1"){echo "checked";}}?>>
							...
							<div class="row">
								...
								<div class="col-md-3">
									<input id="generic" id="generic" type="checkbox" name="opcao[]" value="d1" onclick="teste()" <?php foreach($array_opcoes as $verificacao){if($verificacao == "d1"){echo "checked";}}?>>
