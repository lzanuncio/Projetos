...
if ($_GET['acao'] == "libera"){	
	...
	$lgfinal_ecomex = fopen("logs/ecomex/kecomex_automatic.html", "r+");
	$log_final = fwrite($lgfinal_ecomex, "<table style=\"width: 715px; text-align: center\"><tr><td>Last Update ".$log_data."(".$log_time.") (Brazil/Sao Paulo)</td></tr><tr><td>Numero total de Visitas: ".$contador."</td></tr></table>");
	fclose($lgfinal_ecomex);
	$lgfinal_oracle = fopen("logs/oracle/oracle_automatic.html", "r+");
	$log_final = fwrite($lgfinal_oracle, "<table style=\"width: 715px; text-align: center\"><tr><td>Last Update ".$log_data."(".$log_time.") (Brazil/Sao Paulo)</td></tr><tr><td>Numero total de Visitas: ".$contador."</td></tr></table>");
	fclose($lgfinal_oracle);
...
<html>
	<head>
		...
		<!--[if !IE]>--><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.12.4/css/bootstrap-select.min.css"><!-- <![endif]-->		
		<!--[if !IE]>--><script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.12.4/js/bootstrap-select.min.js"></script><!-- <![endif]-->
		<!--[if !IE]>--><script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.12.4/js/i18n/defaults-*.min.js"></script><!-- <![endif]-->
		...
		<div class="posicao" id="login">
			<div class="ihelp">
				...
				<span class="help">
					...
					<p><font color="red">Em seguida, aperte o botão "Liberar" e aguarde a conclusão.</font>
			...
			<form action="index.php?acao=libera" method="post" target="_self" onsubmit="enviar.disabled=true">
				<div class="divlogin">
